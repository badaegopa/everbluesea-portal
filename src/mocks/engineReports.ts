...
export const engineReports: Record<string, NationReport[]> = {
  ...
  "cat-ui": [
    ...
    {
      id: "ui-irn-vector-2-20260725",
      title: "국가봉기 벡터보고서 — 이란 (IRN) 제2호 · 압박 좌표계 시계열판", titleEn: "National Uprising Vector Report — Iran (IRN) Vol.2 · Pressure Coordinate Time-Series Edition",
      region: "중동", regionEn: "Middle East",
      scope: "단독",
      engine: "UI · Λ¹² 시계열 v2.1 × BSLI v7.0",
      date: "2026-07-25",
      htmlPath: "/engines/ui/국가봉기벡터보고서_IRN_2호_v2.0_20260725_2.html",
    },
    {
      id: "ui-bol-uprising-20260725",
      title: "늘푸른바다 국가보고서 — 볼리비아 (BOL) · 구독판", titleEn: "Everblue Sea Country Report — Bolivia (BOL) · Subscription Edition",
      region: "아메리카", regionEn: "Americas",
      scope: "단독",
      engine: "UI · BSLI v7.0",
      date: "2026-07-25",
      htmlPath: "/engines/ui/국가보고서_구독판_BOL_v2.0_20260725_1.html",
    },
    {
      id: "ui-lka-uprising-20260725",
      title: "늘푸른바다 국가보고서 — 스리랑카 (LKA) · 구독판", titleEn: "Everblue Sea Country Report — Sri Lanka (LKA) · Subscription Edition",
      region: "남아시아", regionEn: "South Asia",
      scope: "단독",
      engine: "UI · BSLI v7.0",
      date: "2026-07-25",
      htmlPath: "/engines/ui/국가보고서_구독판_LKA_v2.0_20260725_1.html",
    },
    {
      id: "ui-cohort-uprising-20260725",
      title: "봉기 코호트 비교 구독판 — 볼리비아·이란·스리랑카·방글라데시·네팔 vs 대조군 한국", titleEn: "Uprising Cohort Comparison (Subscription) — Bolivia·Iran·Sri Lanka·Bangladesh·Nepal vs Control Group Korea",
      region: "아메리카·중동·남아시아", regionEn: "Americas·Middle East·South Asia",
      scope: "권역별",
      engine: "UI · BSLI v7.0",
      date: "2026-07-25",
      htmlPath: "/engines/ui/국가보고서_구독판_봉기코호트비교_v1.0_20260725_1.html",
    },
  ],
